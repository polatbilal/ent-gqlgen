...
import (
	...
	"github.com/polatbilal/gqlgen-ent/api-core/graphql/resolvers"
...
func StartServer(ctx context.Context) error {
	app := fiber.New(fiber.Config{
		...
		AppName:           "API Core Service",
		ErrorHandler: func(c *fiber.Ctx, err error) error {
			log.Printf("[API-CORE] Error: %v", err)
	...
	app.Use(logger.New(logger.Config{
		Format:     "[API-CORE] ${time} | ${status} | ${latency} | ${method} ${path}\n",
