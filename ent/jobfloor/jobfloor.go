...
const (
	// Label holds the string label denoting the jobfloor type in the database.
	Label = "job_floor"
	...
	// EdgeFloor holds the string denoting the floor edge name in mutations.
	EdgeFloor = "floor"
	// Table holds the table name of the jobfloor in the database.
	Table = "job_floors"
	// FloorTable is the table that holds the floor relation/edge.
	FloorTable = "job_floors"
	// FloorInverseTable is the table name for the JobRelations entity.
	// It exists in this package in order to avoid circular dependency with the "jobrelations" package.
	FloorInverseTable = "job_relations"
	// FloorColumn is the table column denoting the floor relation/edge.
	FloorColumn = "relations_id"
)

// Columns holds all SQL columns for jobfloor fields.
var Columns = []string{
	FieldID,
	FieldYibfNo,
	FieldName,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "job_floors"
...
// OrderOption defines the ordering options for the JobFloor queries.
...
// ByFloorField orders the results by floor field.
func ByFloorField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newFloorStep(), sql.OrderByField(field, opts...))
	}
}
func newFloorStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(FloorInverseTable, FieldID),
