...
func (_q *UserQuery) QueryCompanies() *CompanyUserQuery {
...
func (_q *UserQuery) WithCompanies(opts ...func(*CompanyUserQuery)) *UserQuery {
	query := (&CompanyUserClient{config: _q.config}).Query()
...
func (_q *UserQuery) loadCompanies(ctx context.Context, query *CompanyUserQuery, nodes []*User, init func(*User), assign func(*User, *CompanyUser)) error {
	...
	query.Where(predicate.CompanyUser(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.CompaniesColumn), fks...))
	}))
...
func (_q *UserQuery) WithNamedCompanies(name string, opts ...func(*CompanyUserQuery)) *UserQuery {
	query := (&CompanyUserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if _q.withNamedCompanies == nil {
		_q.withNamedCompanies = make(map[string]*CompanyUserQuery)
	}
