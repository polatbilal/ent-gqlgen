...
const (
	...
	// Node types.
	TypeCompanyCareer   = "CompanyCareer"
	TypeCompanyDetail   = "CompanyDetail"
	TypeCompanyEngineer = "CompanyEngineer"
	TypeCompanyOwner    = "CompanyOwner"
	TypeCompanyPosition = "CompanyPosition"
...
// CompanyCareerMutation represents an operation that mutates the CompanyCareer nodes in the graph.
type CompanyCareerMutation struct {
	config
	op                         Op
	typ                        string
	id                         *int
	...
	engineerCareers            map[int]struct{}
	removedengineerCareers     map[int]struct{}
	clearedengineerCareers     bool
	companyOwnerCareers        map[int]struct{}
	removedcompanyOwnerCareers map[int]struct{}
	clearedcompanyOwnerCareers bool
	done                       bool
	oldValue                   func(context.Context) (*CompanyCareer, error)
	predicates                 []predicate.CompanyCareer
}

var _ ent.Mutation = (*CompanyCareerMutation)(nil)

// companycareerOption allows management of the mutation configuration using functional options.
type companycareerOption func(*CompanyCareerMutation)

// newCompanyCareerMutation creates new mutation for the CompanyCareer entity.
func newCompanyCareerMutation(c config, op Op, opts ...companycareerOption) *CompanyCareerMutation {
	m := &CompanyCareerMutation{
		config:        c,
		op:            op,
		typ:           TypeCompanyCareer,
...
// withCompanyCareerID sets the ID field of the mutation.
func withCompanyCareerID(id int) companycareerOption {
	return func(m *CompanyCareerMutation) {
		var (
			err   error
			once  sync.Once
			value *CompanyCareer
		)
		m.oldValue = func(ctx context.Context) (*CompanyCareer, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().CompanyCareer.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withCompanyCareer sets the old CompanyCareer of the mutation.
func withCompanyCareer(node *CompanyCareer) companycareerOption {
	return func(m *CompanyCareerMutation) {
		m.oldValue = func(context.Context) (*CompanyCareer, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
func (m CompanyCareerMutation) Client() *Client {
...
func (m CompanyCareerMutation) Tx() (*Tx, error) {
...
func (m *CompanyCareerMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
func (m *CompanyCareerMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	...
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().CompanyCareer.Query().Where(m.predicates...).IDs(ctx)
	default:
...
func (m *CompanyCareerMutation) SetCareer(s string) {
	m._Career = &s
}

// Career returns the value of the "Career" field in the mutation.
func (m *CompanyCareerMutation) Career() (r string, exists bool) {
	v := m._Career
	if v == nil {
		return
	}
...
// OldCareer returns the old "Career" field's value of the CompanyCareer entity.
// If the CompanyCareer object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CompanyCareerMutation) OldCareer(ctx context.Context) (v string, err error) {
...
func (m *CompanyCareerMutation) ClearCareer() {
	m._Career = nil
	m.clearedFields[companycareer.FieldCareer] = struct{}{}
}

// CareerCleared returns if the "Career" field was cleared in this mutation.
func (m *CompanyCareerMutation) CareerCleared() bool {
	_, ok := m.clearedFields[companycareer.FieldCareer]
	return ok
}

// ResetCareer resets all changes to the "Career" field.
func (m *CompanyCareerMutation) ResetCareer() {
	m._Career = nil
	delete(m.clearedFields, companycareer.FieldCareer)
}

// AddEngineerCareerIDs adds the "engineerCareers" edge to the CompanyEngineer entity by ids.
func (m *CompanyCareerMutation) AddEngineerCareerIDs(ids ...int) {
	if m.engineerCareers == nil {
		m.engineerCareers = make(map[int]struct{})
	}
	for i := range ids {
		m.engineerCareers[ids[i]] = struct{}{}
	}
}

// ClearEngineerCareers clears the "engineerCareers" edge to the CompanyEngineer entity.
func (m *CompanyCareerMutation) ClearEngineerCareers() {
	m.clearedengineerCareers = true
}

// EngineerCareersCleared reports if the "engineerCareers" edge to the CompanyEngineer entity was cleared.
func (m *CompanyCareerMutation) EngineerCareersCleared() bool {
	return m.clearedengineerCareers
}

// RemoveEngineerCareerIDs removes the "engineerCareers" edge to the CompanyEngineer entity by IDs.
func (m *CompanyCareerMutation) RemoveEngineerCareerIDs(ids ...int) {
	if m.removedengineerCareers == nil {
		m.removedengineerCareers = make(map[int]struct{})
	}
	for i := range ids {
		delete(m.engineerCareers, ids[i])
		m.removedengineerCareers[ids[i]] = struct{}{}
	}
}

// RemovedEngineerCareers returns the removed IDs of the "engineerCareers" edge to the CompanyEngineer entity.
func (m *CompanyCareerMutation) RemovedEngineerCareersIDs() (ids []int) {
	for id := range m.removedengineerCareers {
		ids = append(ids, id)
	}
	return
}

// EngineerCareersIDs returns the "engineerCareers" edge IDs in the mutation.
func (m *CompanyCareerMutation) EngineerCareersIDs() (ids []int) {
	for id := range m.engineerCareers {
		ids = append(ids, id)
	}
	return
}

// ResetEngineerCareers resets all changes to the "engineerCareers" edge.
func (m *CompanyCareerMutation) ResetEngineerCareers() {
	m.engineerCareers = nil
	m.clearedengineerCareers = false
	m.removedengineerCareers = nil
}

// AddCompanyOwnerCareerIDs adds the "companyOwnerCareers" edge to the CompanyOwner entity by ids.
func (m *CompanyCareerMutation) AddCompanyOwnerCareerIDs(ids ...int) {
	if m.companyOwnerCareers == nil {
		m.companyOwnerCareers = make(map[int]struct{})
	}
	for i := range ids {
		m.companyOwnerCareers[ids[i]] = struct{}{}
	}
}

// ClearCompanyOwnerCareers clears the "companyOwnerCareers" edge to the CompanyOwner entity.
func (m *CompanyCareerMutation) ClearCompanyOwnerCareers() {
	m.clearedcompanyOwnerCareers = true
}

// CompanyOwnerCareersCleared reports if the "companyOwnerCareers" edge to the CompanyOwner entity was cleared.
func (m *CompanyCareerMutation) CompanyOwnerCareersCleared() bool {
	return m.clearedcompanyOwnerCareers
}

// RemoveCompanyOwnerCareerIDs removes the "companyOwnerCareers" edge to the CompanyOwner entity by IDs.
func (m *CompanyCareerMutation) RemoveCompanyOwnerCareerIDs(ids ...int) {
	if m.removedcompanyOwnerCareers == nil {
		m.removedcompanyOwnerCareers = make(map[int]struct{})
	}
	for i := range ids {
		delete(m.companyOwnerCareers, ids[i])
		m.removedcompanyOwnerCareers[ids[i]] = struct{}{}
	}
}

// RemovedCompanyOwnerCareers returns the removed IDs of the "companyOwnerCareers" edge to the CompanyOwner entity.
func (m *CompanyCareerMutation) RemovedCompanyOwnerCareersIDs() (ids []int) {
	for id := range m.removedcompanyOwnerCareers {
		ids = append(ids, id)
	}
	return
}

// CompanyOwnerCareersIDs returns the "companyOwnerCareers" edge IDs in the mutation.
func (m *CompanyCareerMutation) CompanyOwnerCareersIDs() (ids []int) {
	for id := range m.companyOwnerCareers {
		ids = append(ids, id)
	}
	return
}

// ResetCompanyOwnerCareers resets all changes to the "companyOwnerCareers" edge.
func (m *CompanyCareerMutation) ResetCompanyOwnerCareers() {
	m.companyOwnerCareers = nil
	m.clearedcompanyOwnerCareers = false
	m.removedcompanyOwnerCareers = nil
}

// Where appends a list predicates to the CompanyCareerMutation builder.
func (m *CompanyCareerMutation) Where(ps ...predicate.CompanyCareer) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the CompanyCareerMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *CompanyCareerMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.CompanyCareer, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
func (m *CompanyCareerMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *CompanyCareerMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (CompanyCareer).
func (m *CompanyCareerMutation) Type() string {
	return m.typ
}
...
// AddedFields().
func (m *CompanyCareerMutation) Fields() []string {
	fields := make([]string, 0, 1)
	if m._Career != nil {
		fields = append(fields, companycareer.FieldCareer)
	}
	return fields
}
...
// schema.
func (m *CompanyCareerMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// database failed.
func (m *CompanyCareerMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case companycareer.FieldCareer:
		return m.OldCareer(ctx)
	}
	return nil, fmt.Errorf("unknown CompanyCareer field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *CompanyCareerMutation) SetField(name string, value ent.Value) error {
	switch name {
	case companycareer.FieldCareer:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown CompanyCareer field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *CompanyCareerMutation) AddedFields() []string {
	return nil
}
...
func (m *CompanyCareerMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *CompanyCareerMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown CompanyCareer numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *CompanyCareerMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(companycareer.FieldCareer) {
		fields = append(fields, companycareer.FieldCareer)
	}
	return fields
}
...
func (m *CompanyCareerMutation) FieldCleared(name string) bool {
...
func (m *CompanyCareerMutation) ClearField(name string) error {
	switch name {
	case companycareer.FieldCareer:
		m.ClearCareer()
		return nil
	}
	return fmt.Errorf("unknown CompanyCareer nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *CompanyCareerMutation) ResetField(name string) error {
	switch name {
	case companycareer.FieldCareer:
		m.ResetCareer()
		return nil
...
func (m *CompanyCareerMutation) AddedEdges() []string {
	edges := make([]string, 0, 2)
	if m.engineerCareers != nil {
		edges = append(edges, companycareer.EdgeEngineerCareers)
	}
	if m.companyOwnerCareers != nil {
		edges = append(edges, companycareer.EdgeCompanyOwnerCareers)
	}
	return edges
}
...
func (m *CompanyCareerMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case companycareer.EdgeEngineerCareers:
		ids := make([]ent.Value, 0, len(m.engineerCareers))
		for id := range m.engineerCareers {
			ids = append(ids, id)
		}
		return ids
	case companycareer.EdgeCompanyOwnerCareers:
		ids := make([]ent.Value, 0, len(m.companyOwnerCareers))
		for id := range m.companyOwnerCareers {
			ids = append(ids, id)
		}
		return ids
...
func (m *CompanyCareerMutation) RemovedEdges() []string {
	edges := make([]string, 0, 2)
	if m.removedengineerCareers != nil {
		edges = append(edges, companycareer.EdgeEngineerCareers)
	}
...
func (m *CompanyCareerMutation) RemovedIDs(name string) []ent.Value {
	switch name {
	case companycareer.EdgeEngineerCareers:
		ids := make([]ent.Value, 0, len(m.removedengineerCareers))
		for id := range m.removedengineerCareers {
			ids = append(ids, id)
		}
		return ids
	case companycareer.EdgeCompanyOwnerCareers:
		ids := make([]ent.Value, 0, len(m.removedcompanyOwnerCareers))
		for id := range m.removedcompanyOwnerCareers {
			ids = append(ids, id)
		}
		return ids
...
func (m *CompanyCareerMutation) ClearedEdges() []string {
	edges := make([]string, 0, 2)
	if m.clearedengineerCareers {
		edges = append(edges, companycareer.EdgeEngineerCareers)
	}
	if m.clearedcompanyOwnerCareers {
		edges = append(edges, companycareer.EdgeCompanyOwnerCareers)
	}
	return edges
}
...
func (m *CompanyCareerMutation) EdgeCleared(name string) bool {
	switch name {
	case companycareer.EdgeEngineerCareers:
		return m.clearedengineerCareers
	case companycareer.EdgeCompanyOwnerCareers:
...
func (m *CompanyCareerMutation) ClearEdge(name string) error {
	switch name {
	}
	return fmt.Errorf("unknown CompanyCareer unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *CompanyCareerMutation) ResetEdge(name string) error {
	switch name {
	case companycareer.EdgeEngineerCareers:
		m.ResetEngineerCareers()
		return nil
	case companycareer.EdgeCompanyOwnerCareers:
		m.ResetCompanyOwnerCareers()
		return nil
	}
	return fmt.Errorf("unknown CompanyCareer edge %s", name)
}
...
func (m *CompanyDetailMutation) SetDeleted(i int) {
	m._Deleted = &i
	m.add_Deleted = nil
}

// Deleted returns the value of the "Deleted" field in the mutation.
func (m *CompanyDetailMutation) Deleted() (r int, exists bool) {
	v := m._Deleted
	if v == nil {
		return
	}
...
// OldDeleted returns the old "Deleted" field's value of the CompanyDetail entity.
// If the CompanyDetail object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CompanyDetailMutation) OldDeleted(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CompanyDetailMutation) AddDeleted(i int) {
...
func (m *CompanyDetailMutation) AddedDeleted() (r int, exists bool) {
	v := m.add_Deleted
	if v == nil {
		return
	}
...
func (m *CompanyDetailMutation) ResetDeleted() {
	m._Deleted = nil
	m.add_Deleted = nil
}
...
// CompanyOwnerCleared reports if the "companyOwner" edge to the CompanyOwner entity was cleared.
...
func (m *CompanyDetailMutation) Fields() []string {
	...
	if m._Deleted != nil {
		fields = append(fields, companydetail.FieldDeleted)
	}
	if m._CreatedAt != nil {
...
type CompanyEngineerMutation struct {
	...
	clearedFields              map[string]struct{}
	engineerCareer             *int
	clearedengineerCareer      bool
	engineerPosition           *int
	clearedengineerPosition    bool
...
func (m *CompanyEngineerMutation) SetEngineerCareerID(id int) {
	m.engineerCareer = &id
}

// ClearEngineerCareer clears the "engineerCareer" edge to the CompanyCareer entity.
func (m *CompanyEngineerMutation) ClearEngineerCareer() {
	m.clearedengineerCareer = true
}

// EngineerCareerCleared reports if the "engineerCareer" edge to the CompanyCareer entity was cleared.
func (m *CompanyEngineerMutation) EngineerCareerCleared() bool {
	return m.clearedengineerCareer
}

// EngineerCareerID returns the "engineerCareer" edge ID in the mutation.
func (m *CompanyEngineerMutation) EngineerCareerID() (id int, exists bool) {
	if m.engineerCareer != nil {
		return *m.engineerCareer, true
	}
	return
}

// EngineerCareerIDs returns the "engineerCareer" edge IDs in the mutation.
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// EngineerCareerID instead. It exists only for internal usage by the builders.
func (m *CompanyEngineerMutation) EngineerCareerIDs() (ids []int) {
	if id := m.engineerCareer; id != nil {
		ids = append(ids, *id)
	}
	return
}

// ResetEngineerCareer resets all changes to the "engineerCareer" edge.
func (m *CompanyEngineerMutation) ResetEngineerCareer() {
	m.engineerCareer = nil
	m.clearedengineerCareer = false
}

// SetEngineerPositionID sets the "engineerPosition" edge to the CompanyPosition entity by id.
func (m *CompanyEngineerMutation) SetEngineerPositionID(id int) {
	m.engineerPosition = &id
}

// ClearEngineerPosition clears the "engineerPosition" edge to the CompanyPosition entity.
func (m *CompanyEngineerMutation) ClearEngineerPosition() {
	m.clearedengineerPosition = true
}

// EngineerPositionCleared reports if the "engineerPosition" edge to the CompanyPosition entity was cleared.
func (m *CompanyEngineerMutation) EngineerPositionCleared() bool {
	return m.clearedengineerPosition
}

// EngineerPositionID returns the "engineerPosition" edge ID in the mutation.
func (m *CompanyEngineerMutation) EngineerPositionID() (id int, exists bool) {
	if m.engineerPosition != nil {
		return *m.engineerPosition, true
	}
	return
}

// EngineerPositionIDs returns the "engineerPosition" edge IDs in the mutation.
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// EngineerPositionID instead. It exists only for internal usage by the builders.
func (m *CompanyEngineerMutation) EngineerPositionIDs() (ids []int) {
	if id := m.engineerPosition; id != nil {
		ids = append(ids, *id)
	}
	return
}

// ResetEngineerPosition resets all changes to the "engineerPosition" edge.
func (m *CompanyEngineerMutation) ResetEngineerPosition() {
	m.engineerPosition = nil
	m.clearedengineerPosition = false
}
...
func (m *CompanyEngineerMutation) AddedEdges() []string {
	...
	if m.engineerCareer != nil {
		edges = append(edges, companyengineer.EdgeEngineerCareer)
	}
	if m.engineerPosition != nil {
		edges = append(edges, companyengineer.EdgeEngineerPosition)
	}
	if m.inspectors != nil {
...
func (m *CompanyEngineerMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case companyengineer.EdgeEngineerCareer:
		if id := m.engineerCareer; id != nil {
			return []ent.Value{*id}
		}
	case companyengineer.EdgeEngineerPosition:
		if id := m.engineerPosition; id != nil {
			return []ent.Value{*id}
		}
...
func (m *CompanyEngineerMutation) ClearedEdges() []string {
	edges := make([]string, 0, 10)
	if m.clearedengineerCareer {
		edges = append(edges, companyengineer.EdgeEngineerCareer)
	}
	if m.clearedengineerPosition {
		edges = append(edges, companyengineer.EdgeEngineerPosition)
	}
...
func (m *CompanyEngineerMutation) ClearEdge(name string) error {
	switch name {
	case companyengineer.EdgeEngineerCareer:
		m.ClearEngineerCareer()
		return nil
	case companyengineer.EdgeEngineerPosition:
		m.ClearEngineerPosition()
		return nil
	}
...
func (m *CompanyEngineerMutation) ResetEdge(name string) error {
	switch name {
	case companyengineer.EdgeEngineerCareer:
		m.ResetEngineerCareer()
		return nil
	case companyengineer.EdgeEngineerPosition:
		m.ResetEngineerPosition()
		return nil
	case companyengineer.EdgeInspectors:
		m.ResetInspectors()
		return nil
...
// CompanyOwnerMutation represents an operation that mutates the CompanyOwner nodes in the graph.
type CompanyOwnerMutation struct {
	config
	op                          Op
	typ                         string
	id                          *int
	...
	companyOwnerCareer          *int
	clearedcompanyOwnerCareer   bool
	companyOwnerPosition        *int
	clearedcompanyOwnerPosition bool
	done                        bool
	oldValue                    func(context.Context) (*CompanyOwner, error)
	predicates                  []predicate.CompanyOwner
}

var _ ent.Mutation = (*CompanyOwnerMutation)(nil)

// companyownerOption allows management of the mutation configuration using functional options.
type companyownerOption func(*CompanyOwnerMutation)

// newCompanyOwnerMutation creates new mutation for the CompanyOwner entity.
func newCompanyOwnerMutation(c config, op Op, opts ...companyownerOption) *CompanyOwnerMutation {
	m := &CompanyOwnerMutation{
		config:        c,
		op:            op,
		typ:           TypeCompanyOwner,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withCompanyOwnerID sets the ID field of the mutation.
func withCompanyOwnerID(id int) companyownerOption {
	return func(m *CompanyOwnerMutation) {
		var (
			err   error
			once  sync.Once
			value *CompanyOwner
		)
		m.oldValue = func(ctx context.Context) (*CompanyOwner, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().CompanyOwner.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withCompanyOwner sets the old CompanyOwner of the mutation.
func withCompanyOwner(node *CompanyOwner) companyownerOption {
	return func(m *CompanyOwnerMutation) {
		m.oldValue = func(context.Context) (*CompanyOwner, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m CompanyOwnerMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m CompanyOwnerMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *CompanyOwnerMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *CompanyOwnerMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().CompanyOwner.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetName sets the "Name" field.
func (m *CompanyOwnerMutation) SetName(s string) {
	m._Name = &s
}

// Name returns the value of the "Name" field in the mutation.
func (m *CompanyOwnerMutation) Name() (r string, exists bool) {
	v := m._Name
	if v == nil {
		return
	}
...
// OldName returns the old "Name" field's value of the CompanyOwner entity.
// If the CompanyOwner object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CompanyOwnerMutation) OldName(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldName is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetName resets all changes to the "Name" field.
func (m *CompanyOwnerMutation) ResetName() {
	m._Name = nil
}

// SetRegisterNo sets the "RegisterNo" field.
func (m *CompanyOwnerMutation) SetRegisterNo(i int) {
	m._RegisterNo = &i
	m.add_RegisterNo = nil
}

// RegisterNo returns the value of the "RegisterNo" field in the mutation.
func (m *CompanyOwnerMutation) RegisterNo() (r int, exists bool) {
	v := m._RegisterNo
	if v == nil {
		return
	}
...
// OldRegisterNo returns the old "RegisterNo" field's value of the CompanyOwner entity.
// If the CompanyOwner object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CompanyOwnerMutation) OldRegisterNo(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CompanyOwnerMutation) AddRegisterNo(i int) {
...
func (m *CompanyOwnerMutation) AddedRegisterNo() (r int, exists bool) {
	v := m.add_RegisterNo
	if v == nil {
		return
	}
...
func (m *CompanyOwnerMutation) ClearRegisterNo() {
	m._RegisterNo = nil
	m.add_RegisterNo = nil
	m.clearedFields[companyowner.FieldRegisterNo] = struct{}{}
}

// RegisterNoCleared returns if the "RegisterNo" field was cleared in this mutation.
func (m *CompanyOwnerMutation) RegisterNoCleared() bool {
	_, ok := m.clearedFields[companyowner.FieldRegisterNo]
	return ok
}

// ResetRegisterNo resets all changes to the "RegisterNo" field.
func (m *CompanyOwnerMutation) ResetRegisterNo() {
	m._RegisterNo = nil
	m.add_RegisterNo = nil
	delete(m.clearedFields, companyowner.FieldRegisterNo)
}

// SetCertNo sets the "CertNo" field.
func (m *CompanyOwnerMutation) SetCertNo(i int) {
	m._CertNo = &i
	m.add_CertNo = nil
}

// CertNo returns the value of the "CertNo" field in the mutation.
func (m *CompanyOwnerMutation) CertNo() (r int, exists bool) {
	v := m._CertNo
	if v == nil {
		return
	}
...
// OldCertNo returns the old "CertNo" field's value of the CompanyOwner entity.
// If the CompanyOwner object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CompanyOwnerMutation) OldCertNo(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCertNo is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddCertNo adds i to the "CertNo" field.
func (m *CompanyOwnerMutation) AddCertNo(i int) {
	if m.add_CertNo != nil {
		*m.add_CertNo += i
	} else {
		m.add_CertNo = &i
...
// AddedCertNo returns the value that was added to the "CertNo" field in this mutation.
func (m *CompanyOwnerMutation) AddedCertNo() (r int, exists bool) {
	v := m.add_CertNo
	if v == nil {
		return
	}
...
// ClearCertNo clears the value of the "CertNo" field.
func (m *CompanyOwnerMutation) ClearCertNo() {
	m._CertNo = nil
	m.add_CertNo = nil
	m.clearedFields[companyowner.FieldCertNo] = struct{}{}
}

// CertNoCleared returns if the "CertNo" field was cleared in this mutation.
func (m *CompanyOwnerMutation) CertNoCleared() bool {
	_, ok := m.clearedFields[companyowner.FieldCertNo]
	return ok
}

// ResetCertNo resets all changes to the "CertNo" field.
func (m *CompanyOwnerMutation) ResetCertNo() {
	m._CertNo = nil
	m.add_CertNo = nil
	delete(m.clearedFields, companyowner.FieldCertNo)
}

// SetDeleted sets the "Deleted" field.
func (m *CompanyOwnerMutation) SetDeleted(i int) {
	m._Deleted = &i
	m.add_Deleted = nil
}

// Deleted returns the value of the "Deleted" field in the mutation.
func (m *CompanyOwnerMutation) Deleted() (r int, exists bool) {
	v := m._Deleted
	if v == nil {
		return
	}
...
// OldDeleted returns the old "Deleted" field's value of the CompanyOwner entity.
// If the CompanyOwner object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CompanyOwnerMutation) OldDeleted(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldDeleted is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddDeleted adds i to the "Deleted" field.
func (m *CompanyOwnerMutation) AddDeleted(i int) {
	if m.add_Deleted != nil {
		*m.add_Deleted += i
	} else {
		m.add_Deleted = &i
...
// AddedDeleted returns the value that was added to the "Deleted" field in this mutation.
func (m *CompanyOwnerMutation) AddedDeleted() (r int, exists bool) {
	v := m.add_Deleted
	if v == nil {
		return
	}
...
// ResetDeleted resets all changes to the "Deleted" field.
func (m *CompanyOwnerMutation) ResetDeleted() {
	m._Deleted = nil
	m.add_Deleted = nil
}

// SetCreatedAt sets the "CreatedAt" field.
func (m *CompanyOwnerMutation) SetCreatedAt(t time.Time) {
	m._CreatedAt = &t
}

// CreatedAt returns the value of the "CreatedAt" field in the mutation.
func (m *CompanyOwnerMutation) CreatedAt() (r time.Time, exists bool) {
	v := m._CreatedAt
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "CreatedAt" field's value of the CompanyOwner entity.
// If the CompanyOwner object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CompanyOwnerMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreatedAt resets all changes to the "CreatedAt" field.
func (m *CompanyOwnerMutation) ResetCreatedAt() {
	m._CreatedAt = nil
}

// SetUpdatedAt sets the "UpdatedAt" field.
func (m *CompanyOwnerMutation) SetUpdatedAt(t time.Time) {
	m._UpdatedAt = &t
}

// UpdatedAt returns the value of the "UpdatedAt" field in the mutation.
func (m *CompanyOwnerMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m._UpdatedAt
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "UpdatedAt" field's value of the CompanyOwner entity.
// If the CompanyOwner object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CompanyOwnerMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdatedAt resets all changes to the "UpdatedAt" field.
func (m *CompanyOwnerMutation) ResetUpdatedAt() {
	m._UpdatedAt = nil
}

// AddCompanyOwnerIDs adds the "companyOwners" edge to the CompanyDetail entity by ids.
func (m *CompanyOwnerMutation) AddCompanyOwnerIDs(ids ...int) {
...
func (m *CompanyOwnerMutation) ClearCompanyOwners() {
...
func (m *CompanyOwnerMutation) RemovedCompanyOwnersIDs() (ids []int) {
...
func (m *CompanyOwnerMutation) CompanyOwnersIDs() (ids []int) {
...
func (m *CompanyOwnerMutation) ResetCompanyOwners() {
	m.companyOwners = nil
...
func (m *CompanyOwnerMutation) SetCompanyOwnerCareerID(id int) {
	m.companyOwnerCareer = &id
}

// ClearCompanyOwnerCareer clears the "companyOwnerCareer" edge to the CompanyCareer entity.
func (m *CompanyOwnerMutation) ClearCompanyOwnerCareer() {
	m.clearedcompanyOwnerCareer = true
}

// CompanyOwnerCareerCleared reports if the "companyOwnerCareer" edge to the CompanyCareer entity was cleared.
func (m *CompanyOwnerMutation) CompanyOwnerCareerCleared() bool {
	return m.clearedcompanyOwnerCareer
}

// CompanyOwnerCareerID returns the "companyOwnerCareer" edge ID in the mutation.
func (m *CompanyOwnerMutation) CompanyOwnerCareerID() (id int, exists bool) {
	if m.companyOwnerCareer != nil {
		return *m.companyOwnerCareer, true
	}
	return
}

// CompanyOwnerCareerIDs returns the "companyOwnerCareer" edge IDs in the mutation.
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// CompanyOwnerCareerID instead. It exists only for internal usage by the builders.
func (m *CompanyOwnerMutation) CompanyOwnerCareerIDs() (ids []int) {
	if id := m.companyOwnerCareer; id != nil {
		ids = append(ids, *id)
	}
	return
}

// ResetCompanyOwnerCareer resets all changes to the "companyOwnerCareer" edge.
func (m *CompanyOwnerMutation) ResetCompanyOwnerCareer() {
	m.companyOwnerCareer = nil
	m.clearedcompanyOwnerCareer = false
}

// SetCompanyOwnerPositionID sets the "companyOwnerPosition" edge to the CompanyPosition entity by id.
func (m *CompanyOwnerMutation) SetCompanyOwnerPositionID(id int) {
	m.companyOwnerPosition = &id
}

// ClearCompanyOwnerPosition clears the "companyOwnerPosition" edge to the CompanyPosition entity.
func (m *CompanyOwnerMutation) ClearCompanyOwnerPosition() {
	m.clearedcompanyOwnerPosition = true
}

// CompanyOwnerPositionCleared reports if the "companyOwnerPosition" edge to the CompanyPosition entity was cleared.
func (m *CompanyOwnerMutation) CompanyOwnerPositionCleared() bool {
	return m.clearedcompanyOwnerPosition
}

// CompanyOwnerPositionID returns the "companyOwnerPosition" edge ID in the mutation.
func (m *CompanyOwnerMutation) CompanyOwnerPositionID() (id int, exists bool) {
	if m.companyOwnerPosition != nil {
		return *m.companyOwnerPosition, true
	}
	return
}

// CompanyOwnerPositionIDs returns the "companyOwnerPosition" edge IDs in the mutation.
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// CompanyOwnerPositionID instead. It exists only for internal usage by the builders.
func (m *CompanyOwnerMutation) CompanyOwnerPositionIDs() (ids []int) {
	if id := m.companyOwnerPosition; id != nil {
		ids = append(ids, *id)
	}
	return
}

// ResetCompanyOwnerPosition resets all changes to the "companyOwnerPosition" edge.
func (m *CompanyOwnerMutation) ResetCompanyOwnerPosition() {
	m.companyOwnerPosition = nil
	m.clearedcompanyOwnerPosition = false
}

// Where appends a list predicates to the CompanyOwnerMutation builder.
func (m *CompanyOwnerMutation) Where(ps ...predicate.CompanyOwner) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the CompanyOwnerMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *CompanyOwnerMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.CompanyOwner, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *CompanyOwnerMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *CompanyOwnerMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (CompanyOwner).
func (m *CompanyOwnerMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *CompanyOwnerMutation) Fields() []string {
	fields := make([]string, 0, 6)
	if m._Name != nil {
		fields = append(fields, companyowner.FieldName)
	}
	if m._RegisterNo != nil {
		fields = append(fields, companyowner.FieldRegisterNo)
	}
	if m._CertNo != nil {
		fields = append(fields, companyowner.FieldCertNo)
	}
	if m._Deleted != nil {
		fields = append(fields, companyowner.FieldDeleted)
	}
	if m._CreatedAt != nil {
		fields = append(fields, companyowner.FieldCreatedAt)
	}
	if m._UpdatedAt != nil {
		fields = append(fields, companyowner.FieldUpdatedAt)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *CompanyOwnerMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *CompanyOwnerMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case companyowner.FieldName:
		return m.OldName(ctx)
	case companyowner.FieldRegisterNo:
	...
	return nil, fmt.Errorf("unknown CompanyOwner field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *CompanyOwnerMutation) SetField(name string, value ent.Value) error {
	switch name {
	case companyowner.FieldName:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown CompanyOwner field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *CompanyOwnerMutation) AddedFields() []string {
	var fields []string
	if m.add_RegisterNo != nil {
		fields = append(fields, companyowner.FieldRegisterNo)
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *CompanyOwnerMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case companyowner.FieldRegisterNo:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *CompanyOwnerMutation) AddField(name string, value ent.Value) error {
	switch name {
	case companyowner.FieldRegisterNo:
		v, ok := value.(int)
		if !ok {
	...
	return fmt.Errorf("unknown CompanyOwner numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *CompanyOwnerMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(companyowner.FieldRegisterNo) {
		fields = append(fields, companyowner.FieldRegisterNo)
	}
	if m.FieldCleared(companyowner.FieldCertNo) {
		fields = append(fields, companyowner.FieldCertNo)
	}
	return fields
}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *CompanyOwnerMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *CompanyOwnerMutation) ClearField(name string) error {
	switch name {
	case companyowner.FieldRegisterNo:
		m.ClearRegisterNo()
		return nil
	...
	return fmt.Errorf("unknown CompanyOwner nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *CompanyOwnerMutation) ResetField(name string) error {
	switch name {
	case companyowner.FieldName:
		m.ResetName()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *CompanyOwnerMutation) AddedEdges() []string {
	edges := make([]string, 0, 3)
	if m.companyOwners != nil {
		edges = append(edges, companyowner.EdgeCompanyOwners)
	}
	if m.companyOwnerCareer != nil {
		edges = append(edges, companyowner.EdgeCompanyOwnerCareer)
	}
	if m.companyOwnerPosition != nil {
		edges = append(edges, companyowner.EdgeCompanyOwnerPosition)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *CompanyOwnerMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case companyowner.EdgeCompanyOwners:
		ids := make([]ent.Value, 0, len(m.companyOwners))
		for id := range m.companyOwners {
			ids = append(ids, id)
		}
		return ids
	case companyowner.EdgeCompanyOwnerCareer:
		if id := m.companyOwnerCareer; id != nil {
			return []ent.Value{*id}
		}
	case companyowner.EdgeCompanyOwnerPosition:
		if id := m.companyOwnerPosition; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *CompanyOwnerMutation) RemovedEdges() []string {
	edges := make([]string, 0, 3)
	if m.removedcompanyOwners != nil {
		edges = append(edges, companyowner.EdgeCompanyOwners)
	}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *CompanyOwnerMutation) RemovedIDs(name string) []ent.Value {
	switch name {
	case companyowner.EdgeCompanyOwners:
...
// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *CompanyOwnerMutation) ClearedEdges() []string {
	edges := make([]string, 0, 3)
	if m.clearedcompanyOwners {
		edges = append(edges, companyowner.EdgeCompanyOwners)
	}
	if m.clearedcompanyOwnerCareer {
		edges = append(edges, companyowner.EdgeCompanyOwnerCareer)
	}
	if m.clearedcompanyOwnerPosition {
		edges = append(edges, companyowner.EdgeCompanyOwnerPosition)
	}
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *CompanyOwnerMutation) EdgeCleared(name string) bool {
	switch name {
	case companyowner.EdgeCompanyOwners:
		return m.clearedcompanyOwners
	case companyowner.EdgeCompanyOwnerCareer:
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *CompanyOwnerMutation) ClearEdge(name string) error {
	switch name {
	case companyowner.EdgeCompanyOwnerCareer:
		m.ClearCompanyOwnerCareer()
		return nil
	case companyowner.EdgeCompanyOwnerPosition:
		m.ClearCompanyOwnerPosition()
		return nil
	}
	return fmt.Errorf("unknown CompanyOwner unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *CompanyOwnerMutation) ResetEdge(name string) error {
	switch name {
	case companyowner.EdgeCompanyOwners:
		m.ResetCompanyOwners()
		return nil
	case companyowner.EdgeCompanyOwnerCareer:
		m.ResetCompanyOwnerCareer()
		return nil
	case companyowner.EdgeCompanyOwnerPosition:
		m.ResetCompanyOwnerPosition()
		return nil
	}
	return fmt.Errorf("unknown CompanyOwner edge %s", name)
}

// CompanyPositionMutation represents an operation that mutates the CompanyPosition nodes in the graph.
type CompanyPositionMutation struct {
	config
	op                           Op
	typ                          string
	id                           *int
	_Position                    *string
	clearedFields                map[string]struct{}
	engineerPositions            map[int]struct{}
	removedengineerPositions     map[int]struct{}
	clearedengineerPositions     bool
	companyOwnerPositions        map[int]struct{}
	removedcompanyOwnerPositions map[int]struct{}
	clearedcompanyOwnerPositions bool
	done                         bool
	oldValue                     func(context.Context) (*CompanyPosition, error)
	predicates                   []predicate.CompanyPosition
}

var _ ent.Mutation = (*CompanyPositionMutation)(nil)

// companypositionOption allows management of the mutation configuration using functional options.
type companypositionOption func(*CompanyPositionMutation)

// newCompanyPositionMutation creates new mutation for the CompanyPosition entity.
func newCompanyPositionMutation(c config, op Op, opts ...companypositionOption) *CompanyPositionMutation {
	m := &CompanyPositionMutation{
		config:        c,
		op:            op,
		typ:           TypeCompanyPosition,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withCompanyPositionID sets the ID field of the mutation.
func withCompanyPositionID(id int) companypositionOption {
	return func(m *CompanyPositionMutation) {
		var (
			err   error
			once  sync.Once
			value *CompanyPosition
		)
		m.oldValue = func(ctx context.Context) (*CompanyPosition, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().CompanyPosition.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withCompanyPosition sets the old CompanyPosition of the mutation.
func withCompanyPosition(node *CompanyPosition) companypositionOption {
	return func(m *CompanyPositionMutation) {
		m.oldValue = func(context.Context) (*CompanyPosition, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m CompanyPositionMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m CompanyPositionMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *CompanyPositionMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *CompanyPositionMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().CompanyPosition.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
func (m *CompanyPositionMutation) SetPosition(s string) {
	m._Position = &s
}

// Position returns the value of the "Position" field in the mutation.
func (m *CompanyPositionMutation) Position() (r string, exists bool) {
	v := m._Position
	if v == nil {
		return
	}
...
// OldPosition returns the old "Position" field's value of the CompanyPosition entity.
// If the CompanyPosition object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CompanyPositionMutation) OldPosition(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CompanyPositionMutation) ClearPosition() {
	m._Position = nil
	m.clearedFields[companyposition.FieldPosition] = struct{}{}
}

// PositionCleared returns if the "Position" field was cleared in this mutation.
func (m *CompanyPositionMutation) PositionCleared() bool {
	_, ok := m.clearedFields[companyposition.FieldPosition]
	return ok
}

// ResetPosition resets all changes to the "Position" field.
func (m *CompanyPositionMutation) ResetPosition() {
	m._Position = nil
	delete(m.clearedFields, companyposition.FieldPosition)
}

// AddEngineerPositionIDs adds the "engineerPositions" edge to the CompanyEngineer entity by ids.
func (m *CompanyPositionMutation) AddEngineerPositionIDs(ids ...int) {
	if m.engineerPositions == nil {
		m.engineerPositions = make(map[int]struct{})
	}
	for i := range ids {
		m.engineerPositions[ids[i]] = struct{}{}
	}
}

// ClearEngineerPositions clears the "engineerPositions" edge to the CompanyEngineer entity.
func (m *CompanyPositionMutation) ClearEngineerPositions() {
	m.clearedengineerPositions = true
}

// EngineerPositionsCleared reports if the "engineerPositions" edge to the CompanyEngineer entity was cleared.
func (m *CompanyPositionMutation) EngineerPositionsCleared() bool {
	return m.clearedengineerPositions
}

// RemoveEngineerPositionIDs removes the "engineerPositions" edge to the CompanyEngineer entity by IDs.
func (m *CompanyPositionMutation) RemoveEngineerPositionIDs(ids ...int) {
	if m.removedengineerPositions == nil {
		m.removedengineerPositions = make(map[int]struct{})
	}
	for i := range ids {
		delete(m.engineerPositions, ids[i])
		m.removedengineerPositions[ids[i]] = struct{}{}
	}
}

// RemovedEngineerPositions returns the removed IDs of the "engineerPositions" edge to the CompanyEngineer entity.
func (m *CompanyPositionMutation) RemovedEngineerPositionsIDs() (ids []int) {
	for id := range m.removedengineerPositions {
		ids = append(ids, id)
	}
	return
}

// EngineerPositionsIDs returns the "engineerPositions" edge IDs in the mutation.
func (m *CompanyPositionMutation) EngineerPositionsIDs() (ids []int) {
	for id := range m.engineerPositions {
		ids = append(ids, id)
	}
	return
}

// ResetEngineerPositions resets all changes to the "engineerPositions" edge.
func (m *CompanyPositionMutation) ResetEngineerPositions() {
	m.engineerPositions = nil
	m.clearedengineerPositions = false
	m.removedengineerPositions = nil
}

// AddCompanyOwnerPositionIDs adds the "companyOwnerPositions" edge to the CompanyOwner entity by ids.
func (m *CompanyPositionMutation) AddCompanyOwnerPositionIDs(ids ...int) {
	if m.companyOwnerPositions == nil {
		m.companyOwnerPositions = make(map[int]struct{})
	}
	for i := range ids {
		m.companyOwnerPositions[ids[i]] = struct{}{}
	}
}

// ClearCompanyOwnerPositions clears the "companyOwnerPositions" edge to the CompanyOwner entity.
func (m *CompanyPositionMutation) ClearCompanyOwnerPositions() {
	m.clearedcompanyOwnerPositions = true
}

// CompanyOwnerPositionsCleared reports if the "companyOwnerPositions" edge to the CompanyOwner entity was cleared.
func (m *CompanyPositionMutation) CompanyOwnerPositionsCleared() bool {
	return m.clearedcompanyOwnerPositions
}

// RemoveCompanyOwnerPositionIDs removes the "companyOwnerPositions" edge to the CompanyOwner entity by IDs.
func (m *CompanyPositionMutation) RemoveCompanyOwnerPositionIDs(ids ...int) {
	if m.removedcompanyOwnerPositions == nil {
		m.removedcompanyOwnerPositions = make(map[int]struct{})
	}
	for i := range ids {
		delete(m.companyOwnerPositions, ids[i])
		m.removedcompanyOwnerPositions[ids[i]] = struct{}{}
	}
}

// RemovedCompanyOwnerPositions returns the removed IDs of the "companyOwnerPositions" edge to the CompanyOwner entity.
func (m *CompanyPositionMutation) RemovedCompanyOwnerPositionsIDs() (ids []int) {
	for id := range m.removedcompanyOwnerPositions {
		ids = append(ids, id)
	}
	return
}

// CompanyOwnerPositionsIDs returns the "companyOwnerPositions" edge IDs in the mutation.
func (m *CompanyPositionMutation) CompanyOwnerPositionsIDs() (ids []int) {
	for id := range m.companyOwnerPositions {
		ids = append(ids, id)
	}
	return
}

// ResetCompanyOwnerPositions resets all changes to the "companyOwnerPositions" edge.
func (m *CompanyPositionMutation) ResetCompanyOwnerPositions() {
	m.companyOwnerPositions = nil
	m.clearedcompanyOwnerPositions = false
	m.removedcompanyOwnerPositions = nil
}

// Where appends a list predicates to the CompanyPositionMutation builder.
func (m *CompanyPositionMutation) Where(ps ...predicate.CompanyPosition) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the CompanyPositionMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *CompanyPositionMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.CompanyPosition, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *CompanyPositionMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *CompanyPositionMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (CompanyPosition).
func (m *CompanyPositionMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *CompanyPositionMutation) Fields() []string {
	fields := make([]string, 0, 1)
	if m._Position != nil {
		fields = append(fields, companyposition.FieldPosition)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *CompanyPositionMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *CompanyPositionMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case companyposition.FieldPosition:
		return m.OldPosition(ctx)
	}
	return nil, fmt.Errorf("unknown CompanyPosition field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *CompanyPositionMutation) SetField(name string, value ent.Value) error {
	switch name {
	case companyposition.FieldPosition:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown CompanyPosition field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *CompanyPositionMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *CompanyPositionMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *CompanyPositionMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown CompanyPosition numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *CompanyPositionMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(companyposition.FieldPosition) {
		fields = append(fields, companyposition.FieldPosition)
	}
	return fields
}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *CompanyPositionMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *CompanyPositionMutation) ClearField(name string) error {
	switch name {
	case companyposition.FieldPosition:
		m.ClearPosition()
		return nil
	}
	return fmt.Errorf("unknown CompanyPosition nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *CompanyPositionMutation) ResetField(name string) error {
	switch name {
	case companyposition.FieldPosition:
		m.ResetPosition()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *CompanyPositionMutation) AddedEdges() []string {
	edges := make([]string, 0, 2)
	if m.engineerPositions != nil {
		edges = append(edges, companyposition.EdgeEngineerPositions)
	}
	if m.companyOwnerPositions != nil {
		edges = append(edges, companyposition.EdgeCompanyOwnerPositions)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *CompanyPositionMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case companyposition.EdgeEngineerPositions:
		ids := make([]ent.Value, 0, len(m.engineerPositions))
		for id := range m.engineerPositions {
			ids = append(ids, id)
		}
		return ids
	case companyposition.EdgeCompanyOwnerPositions:
		ids := make([]ent.Value, 0, len(m.companyOwnerPositions))
		for id := range m.companyOwnerPositions {
			ids = append(ids, id)
		}
		return ids
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *CompanyPositionMutation) RemovedEdges() []string {
	edges := make([]string, 0, 2)
	if m.removedengineerPositions != nil {
		edges = append(edges, companyposition.EdgeEngineerPositions)
	}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *CompanyPositionMutation) RemovedIDs(name string) []ent.Value {
	switch name {
	case companyposition.EdgeEngineerPositions:
		ids := make([]ent.Value, 0, len(m.removedengineerPositions))
		for id := range m.removedengineerPositions {
			ids = append(ids, id)
		}
		return ids
	case companyposition.EdgeCompanyOwnerPositions:
		ids := make([]ent.Value, 0, len(m.removedcompanyOwnerPositions))
		for id := range m.removedcompanyOwnerPositions {
			ids = append(ids, id)
		}
		return ids
...
// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *CompanyPositionMutation) ClearedEdges() []string {
	edges := make([]string, 0, 2)
	if m.clearedengineerPositions {
		edges = append(edges, companyposition.EdgeEngineerPositions)
	}
	if m.clearedcompanyOwnerPositions {
		edges = append(edges, companyposition.EdgeCompanyOwnerPositions)
	}
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *CompanyPositionMutation) EdgeCleared(name string) bool {
	switch name {
	case companyposition.EdgeEngineerPositions:
		return m.clearedengineerPositions
	case companyposition.EdgeCompanyOwnerPositions:
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *CompanyPositionMutation) ClearEdge(name string) error {
	switch name {
	}
	return fmt.Errorf("unknown CompanyPosition unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *CompanyPositionMutation) ResetEdge(name string) error {
	switch name {
	case companyposition.EdgeEngineerPositions:
		m.ResetEngineerPositions()
		return nil
	case companyposition.EdgeCompanyOwnerPositions:
		m.ResetCompanyOwnerPositions()
		return nil
	}
	return fmt.Errorf("unknown CompanyPosition edge %s", name)
}
...
// SetDeleted sets the "Deleted" field.
func (m *JobAuthorMutation) SetDeleted(i int) {
	m._Deleted = &i
	m.add_Deleted = nil
}

// Deleted returns the value of the "Deleted" field in the mutation.
func (m *JobAuthorMutation) Deleted() (r int, exists bool) {
	v := m._Deleted
	if v == nil {
		return
	}
...
// OldDeleted returns the old "Deleted" field's value of the JobAuthor entity.
// If the JobAuthor object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *JobAuthorMutation) OldDeleted(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldDeleted is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddDeleted adds i to the "Deleted" field.
func (m *JobAuthorMutation) AddDeleted(i int) {
	if m.add_Deleted != nil {
		*m.add_Deleted += i
	} else {
		m.add_Deleted = &i
...
// AddedDeleted returns the value that was added to the "Deleted" field in this mutation.
func (m *JobAuthorMutation) AddedDeleted() (r int, exists bool) {
	v := m.add_Deleted
	if v == nil {
		return
	}
...
// ResetDeleted resets all changes to the "Deleted" field.
func (m *JobAuthorMutation) ResetDeleted() {
	m._Deleted = nil
	m.add_Deleted = nil
}
...
func (m *JobAuthorMutation) Fields() []string {
	...
	if m._Deleted != nil {
		fields = append(fields, jobauthor.FieldDeleted)
	}
	if m._CreatedAt != nil {
...
// SetDeleted sets the "Deleted" field.
func (m *JobContractorMutation) SetDeleted(i int) {
	m._Deleted = &i
	m.add_Deleted = nil
}

// Deleted returns the value of the "Deleted" field in the mutation.
func (m *JobContractorMutation) Deleted() (r int, exists bool) {
	v := m._Deleted
	if v == nil {
		return
	}
...
// OldDeleted returns the old "Deleted" field's value of the JobContractor entity.
// If the JobContractor object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *JobContractorMutation) OldDeleted(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldDeleted is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddDeleted adds i to the "Deleted" field.
func (m *JobContractorMutation) AddDeleted(i int) {
	if m.add_Deleted != nil {
		*m.add_Deleted += i
	} else {
		m.add_Deleted = &i
...
// AddedDeleted returns the value that was added to the "Deleted" field in this mutation.
func (m *JobContractorMutation) AddedDeleted() (r int, exists bool) {
	v := m.add_Deleted
	if v == nil {
		return
	}
...
// ResetDeleted resets all changes to the "Deleted" field.
func (m *JobContractorMutation) ResetDeleted() {
	m._Deleted = nil
	m.add_Deleted = nil
}
...
func (m *JobContractorMutation) Fields() []string {
	...
	if m._Deleted != nil {
		fields = append(fields, jobcontractor.FieldDeleted)
	}
	if m._CreatedAt != nil {
...
// SetDeleted sets the "Deleted" field.
func (m *JobOwnerMutation) SetDeleted(i int) {
	m._Deleted = &i
	m.add_Deleted = nil
}

// Deleted returns the value of the "Deleted" field in the mutation.
func (m *JobOwnerMutation) Deleted() (r int, exists bool) {
	v := m._Deleted
	if v == nil {
		return
	}
...
// OldDeleted returns the old "Deleted" field's value of the JobOwner entity.
// If the JobOwner object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *JobOwnerMutation) OldDeleted(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldDeleted is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddDeleted adds i to the "Deleted" field.
func (m *JobOwnerMutation) AddDeleted(i int) {
	if m.add_Deleted != nil {
		*m.add_Deleted += i
	} else {
		m.add_Deleted = &i
...
// AddedDeleted returns the value that was added to the "Deleted" field in this mutation.
func (m *JobOwnerMutation) AddedDeleted() (r int, exists bool) {
	v := m.add_Deleted
	if v == nil {
		return
	}
...
// ResetDeleted resets all changes to the "Deleted" field.
func (m *JobOwnerMutation) ResetDeleted() {
	m._Deleted = nil
	m.add_Deleted = nil
}
...
func (m *JobOwnerMutation) Fields() []string {
	...
	if m._Deleted != nil {
		fields = append(fields, jobowner.FieldDeleted)
	}
	if m.created_at != nil {
