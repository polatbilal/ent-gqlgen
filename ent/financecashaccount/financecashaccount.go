...
const (
	// Label holds the string label denoting the financecashaccount type in the database.
	Label = "finance_cash_account"
	...
	// Table holds the table name of the financecashaccount in the database.
	Table = "cash_accounts"
	// CompanyTable is the table that holds the company relation/edge.
	CompanyTable = "cash_accounts"
	...
	OperationsTable = "cash_account_operations"
	// OperationsInverseTable is the table name for the FinanceCashAccountOperation entity.
	// It exists in this package in order to avoid circular dependency with the "financecashaccountoperation" package.
	OperationsInverseTable = "cash_account_operations"
	// OperationsColumn is the table column denoting the operations relation/edge.
	OperationsColumn = "cash_account_id"
)

// Columns holds all SQL columns for financecashaccount fields.
var Columns = []string{
	FieldID,
	FieldDescription,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "cash_accounts"
...
// OrderOption defines the ordering options for the FinanceCashAccount queries.
