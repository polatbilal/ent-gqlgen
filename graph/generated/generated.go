...
import (
	...
	"github.com/polatbilal/gqlgen-ent/graph/scalars"
...
func (ec *executionContext) field_Mutation_createSupervisor_argsInput(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNJobSupervisorInput2githubᚗcomᚋpolatbilalᚋgqlgenᚑentᚋgraphᚋmodelᚐJobSupervisorInput(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_createToken_argsInput(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNCompanyTokenInput2githubᚗcomᚋpolatbilalᚋgqlgenᚑentᚋgraphᚋmodelᚐCompanyTokenInput(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_updateProgress_argsInput(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNJobProgressInput2githubᚗcomᚋpolatbilalᚋgqlgenᚑentᚋgraphᚋmodelᚐJobProgressInput(ctx, tmp)
	}
...
func (ec *executionContext) _JobPayments(ctx context.Context, sel ast.SelectionSet, obj *ent.JobPayments) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "Date":
			out.Values[i] = ec._JobPayments_Date(ctx, field, obj)
		case "Amount":
...
func (ec *executionContext) unmarshalNCompanyTokenInput2githubᚗcomᚋpolatbilalᚋgqlgenᚑentᚋgraphᚋmodelᚐCompanyTokenInput(ctx context.Context, v any) (model.CompanyTokenInput, error) {
...
func (ec *executionContext) unmarshalNJobProgressInput2githubᚗcomᚋpolatbilalᚋgqlgenᚑentᚋgraphᚋmodelᚐJobProgressInput(ctx context.Context, v any) (model.JobProgressInput, error) {
...
func (ec *executionContext) unmarshalNJobSupervisorInput2githubᚗcomᚋpolatbilalᚋgqlgenᚑentᚋgraphᚋmodelᚐJobSupervisorInput(ctx context.Context, v any) (model.JobSupervisorInput, error) {
